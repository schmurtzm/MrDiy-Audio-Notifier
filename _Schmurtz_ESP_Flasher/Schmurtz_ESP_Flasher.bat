...
if /i "%userinp%"=="1" set Selected_Firmware=FW_v0.4_ESP32_esp32doit-devkit-v4.bin & goto :FlashESP32
if /i "%userinp%"=="2" set Selected_Firmware=FW_v0.4_ESP8266_d1_mini.bin & goto :FlashESP8266
